...
<body>
  <div class="container" style="padding-top: 18px;">
    <div class="card">
      ...
      <p class="page-subtitle">Connecté: <?= h((string)($user['prenom'] ?? '')) ?> <?= h((string)($user['nom'] ?? '')) ?></p>
      <hr />

      <div class="row">
        <a class="btn primary" href="./liste.php">Liste</a>
        <button class="btn" type="button" onclick="toggleParams()">Paramètres</button>
      </div>

      <div class="spacer"></div>
      <div class="todo">Menu admin : accès à la liste des élèves et aux paramètres.</div>
